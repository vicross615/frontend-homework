...
const Company: React.FC<ICompanyProps> = ({onCompanyChange, selectedCompany, company, hideDropdown}: ICompanyProps) => {
    ...
    return (
        <div
            className={company.value === selectedCompany.value ? 'selected-company' : undefined}
...
const mapDispatchToProps = (dispatch: any) => ({
    onCompanyChange: (company: ICompany) => dispatch(selectCompanyAction(company)),
